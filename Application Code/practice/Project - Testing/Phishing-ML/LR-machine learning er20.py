...
# This step is useful if you have very large ranges of values that might benefit from scaling down.
...
joblib.dump(top_features, '/results/random_forest_phishing_detector_erc20_features.pkl')
...
model_filename = '/results/random_forest_phishing_detector_erc20.pkl'
