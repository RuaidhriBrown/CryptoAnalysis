...
joblib.dump(top_features, 'random_forest_moneyLaundering_detector_transactions_features.pkl')
...
model_filename = 'random_forest_moneyLaundering_detector_transactions.pkl'
