...
# Load the datasets
transactions_df = pd.read_csv('datasets/ethereum/MoneyLaundering/all_erc20_transactions.csv')
transactions_0_df = pd.read_csv('datasets/ethereum/combined_er20.csv')
...
combined_transactions_df.to_csv('datasets/ethereum/combined_er20_transaction_data.csv', index=False)
