...
def load_phishing_wallet_model():
    # Define the directory paths
    models_dir = os.path.join(settings.BASE_DIR, 'models')
    ethereum_dir = os.path.join(models_dir, 'ethereum')
    phishing_dir = os.path.join(ethereum_dir, 'phishing')

    # Define the paths for the wallet model and features
    wallet_model_path = os.path.join(phishing_dir, 'random_forest_phishing_detector_aggregated.pkl')
    wallet_features_path = os.path.join(phishing_dir, 'random_forest_phishing_detector_aggregated_features.pkl')
...
def load_phishing_transaction_model():
    # Define the directory paths
    models_dir = os.path.join(settings.BASE_DIR, 'models')
    ethereum_dir = os.path.join(models_dir, 'ethereum')
    phishing_dir = os.path.join(ethereum_dir, 'phishing')
    ...
    transaction_model_path = os.path.join(phishing_dir, 'random_forest_phishing_detector_transactions.pkl')
    transaction_features_path = os.path.join(phishing_dir, 'random_forest_phishing_detector_transactions_features.pkl')
...
def load_phishing_erc20_model():
    ...
    erc20_model_path = os.path.join(phishing_dir, 'random_forest_phishing_detector_erc20.pkl')
    erc20_features_path = os.path.join(phishing_dir, 'random_forest_phishing_detector_erc20_features.pkl')
